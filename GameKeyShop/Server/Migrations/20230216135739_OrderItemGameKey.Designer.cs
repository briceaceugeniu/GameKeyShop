...
namespace GameKeyShop.Server.Migrations
{
    ...
    [Migration("20230216135739_OrderItemGameKey")]
    partial class OrderItemGameKey
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GameKeyShop.Shared.Models.CreditCard", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GameKeyShop.Shared.Models.OrderItem", b =>
                {
                    ...
                    b.HasKey("OrderId", "ProductId", "PlatformTypeId", "GameKey");
            ...
            modelBuilder.Entity("GameKeyShop.Shared.Models.CreditCard", b =>
                {
                    b.HasOne("GameKeyShop.Shared.Models.User", null)
                        .WithOne("CreditCard")
                        .HasForeignKey("GameKeyShop.Shared.Models.CreditCard", "UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
