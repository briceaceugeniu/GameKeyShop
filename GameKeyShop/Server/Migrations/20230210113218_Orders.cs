    ...
    public partial class Orders : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.AddPrimaryKey(
                name: "PK_CartItems",
                table: "CartItems",
                columns: new[] { "UserId", "ProductId", "PlatformTypeId" });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderItems", x => new { x.OrderId, x.ProductId, x.PlatformTypeId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_PlatformTypeId",
                table: "OrderItems",
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.AddPrimaryKey(
                name: "PK_CartItems",
                table: "CartItems",
                columns: new[] { "ProductId", "PlatformTypeId", "UserId" });
        }
    }
}
